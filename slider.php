...
if ( $query->have_posts() ) { ?>
	<div class="flexslider nonprofit-flexslider">
		<ul class="slides nonprofit-slides">
			<?php add_filter( 'excerpt_more', 'nonprofit_excerpt_for_slider' ); add_filter( 'excerpt_length', 'nonprofit_length_for_slider' ); ?>
				...
				$query->the_post(); ?>
					<li>
						<div class="nonprofit-slider-text aligncenter">
							...
							<a class="slider-more" href="<?php the_permalink(); ?>"><?php _e( 'Learn More', 'nonprofit' ); ?></a>
			...
			<?php } ?>
			<?php remove_filter( 'excerpt_more', 'nonprofit_excerpt_for_slider' ); remove_filter( 'excerpt_length', 'nonprofit_length_for_slider' ); ?>
		</ul><!-- .slides -->
	</div><!-- .flexslider -->
<?php }
wp_reset_postdata(); ?>