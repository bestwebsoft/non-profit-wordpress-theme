						...
						<article>
							...
							<div class="nonprofit-post-date">
								<p><?php echo __( 'Posted on', 'nonprofit' ). '&nbsp;'; ?>
									<a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>" ><?php the_time( 'd M, Y' ); ?></a>
									<?php echo '&nbsp;' . __( 'at', 'nonprofit' ); ?> <a href="<?php echo wp_get_attachment_url(); ?>" target="_blank"><?php echo $metadata[ 'width' ].' &times; '.$metadata[ 'height' ]; ?></a>
									<?php _e( 'in', 'nonprofit' ); ?> <a href = "<?php echo get_permalink( $post->post_parent ); ?>"><?php echo get_the_title( $post->post_parent ); ?></a>
									<?php '&nbsp;'. edit_post_link( __( 'Edit', 'nonprofit' ), '<span class="edit-link">', '</span>' ); ?>
								</p>
							</div> 
								...
								<nav id="image_navigation" class="nonpofit-navigation image-navigation">
									<div class="nonprofit-atachment-links">
										<div class="previous-image-nonprofit">
											<?php previous_image_link( false, __( 'Previous Image', 'nonprofit' ) ); ?>
											<div class="nonprofit-see-prev">
												<?php previous_image_link(); ?>
											</div>
										</div>
										<div class="next-image-nonprofit">
											<?php next_image_link( false, __( 'Next Image', 'nonprofit' ) ); ?>
